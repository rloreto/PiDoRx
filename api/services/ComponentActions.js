...
module.exports = {
    changeOnOffState: function(component, state, type) {
      ...
      return rp({
        ...
        formData: { state: state, type: type }
      })
    ...
    changeDimmerState: function(component, state) {
      var dimmerGpio = null;
      var id = null;
      var requestState;
      switch (state) {
    ...
    changeBlindPosition: function(component, state){
      ...
      if(state === 'up'){
        action = 'up';
        requestWait = totalMilliseconds / 20.0;
      } else if (state === 'down'){
        action = 'down';
        requestWait = totalMilliseconds / 20.0;
      }  else{
      ...
      var formData ={state: requestState};
      if(requestWait){
    ...
    getDhtSensorTemperature: function(component){
      var outGpio = null;
      var id = null;
    ...
    getLuminanceSensor: function(component){
      var outGpio = null;
      var id = null;
    ...
    updateGpiosValues: function(component){
