                        ...
                        <Col xs={12} className='text-center'>
                          <div>
                            <ButtonGroup>
                              ...
                              <ButtonGroup dropdown>
                                <DropdownButton outlined bsStyle='paleblue'>
                                  <span>Dropdown </span><Caret/>
                                </DropdownButton>
                                <Menu bsStyle='paleblue'>
                                  <MenuItem href='#'>Regular link</MenuItem>
                                  <MenuItem href='#' disabled>Disabled link</MenuItem>
                                  <MenuItem href='#'>Another link</MenuItem>
                                </Menu>
                      ...
                      <Row>
                        <Col xs={6} className='text-center'>
                          ...
                          <ButtonGroup vertical>
                            ...
                            <Button bsStyle='darkorange'>Button</Button>
                            <ButtonGroup dropdown>
                              <DropdownButton bsStyle='darkorange'>
                                <span>Dropdown </span><Caret/>
                              </DropdownButton>
                              <Menu bsStyle='darkorange'>
                                <MenuItem href='#'>Regular link</MenuItem>
                                <MenuItem href='#' disabled>Disabled link</MenuItem>
                                <MenuItem href='#'>Another link</MenuItem>
                              </Menu>
                        ...
                        <Col xs={6} className='text-center'>
                          ...
                          <ButtonGroup vertical>
                            ...
                            <Button outlined bsStyle='pinkishred'>Button</Button>
                            <ButtonGroup dropdown>
                              <DropdownButton outlined bsStyle='pinkishred'>
                                <span>Dropdown </span><Caret/>
                              </DropdownButton>
                              <Menu alignRight bsStyle='pinkishred'>
                                <MenuItem href='#'>Regular link</MenuItem>
                                <MenuItem href='#' disabled>Disabled link</MenuItem>
                                <MenuItem href='#'>Another link</MenuItem>
                              </Menu>
                      ...
                      <Row>
                        <Col xs={12} className='text-center'>
                          ...
                          <ButtonGroup justified>
                            ...
                            <ButtonGroup dropdown>
                              <DropdownButton bsStyle='brightyellow'>
                                <span>Dropdown </span><Caret/>
                              </DropdownButton>
                              <Menu bsStyle='brightyellow' alignRight>
                                <MenuItem href='#'>Regular link</MenuItem>
                                <MenuItem href='#' disabled>Disabled link</MenuItem>
                                <MenuItem href='#'>Another link</MenuItem>
                              </Menu>
                          ...
                          <ButtonGroup justified>
                            ...
                            <ButtonGroup dropdown>
                              <DropdownButton outlined bsStyle='brightyellow'>
                                <span>Dropdown </span><Caret/>
                              </DropdownButton>
                              <Menu bsStyle='brightyellow' alignRight>
                                <MenuItem href='#'>Regular link</MenuItem>
